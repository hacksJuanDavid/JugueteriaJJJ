...
def InterfaceInsert():
    ...
    try:
        ...
        edad_recomendada = edad_recomendada.text_input(
            'Edad recomendada', key='input_edad_recomendada', type='default')
        ...
        precio = precio.text_input(
            'Precio', key='input_precio', type='default')
    ...
    if button:
        ...
        # Si todos los campos estan llenos
            ...
            # Insertar el juguete en la base de datos
            insertToy(name, edad_recomendada, descripcion,
                      imagen, precio, stock, marca, categoria)
            # Texto de exito
